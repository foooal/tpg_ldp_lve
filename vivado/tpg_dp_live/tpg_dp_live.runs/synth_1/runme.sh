...
HD_PWD='C:/Users/shen/Downloads/vitis_2/dp_live/dp_live.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mpsoc_preset_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mpsoc_preset_wrapper.tcl
