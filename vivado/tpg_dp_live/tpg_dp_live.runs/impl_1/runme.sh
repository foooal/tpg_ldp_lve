...
HD_PWD='C:/Users/shen/Downloads/vitis_2/dp_live/dp_live.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mpsoc_preset_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mpsoc_preset_wrapper.tcl -notrace
