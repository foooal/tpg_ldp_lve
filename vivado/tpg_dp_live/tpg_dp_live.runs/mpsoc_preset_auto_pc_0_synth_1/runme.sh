...
HD_PWD='C:/Users/shen/Downloads/project_33/project_33.runs/mpsoc_preset_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mpsoc_preset_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mpsoc_preset_auto_pc_0.tcl
